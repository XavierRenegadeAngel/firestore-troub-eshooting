...
class MainTopicExpansionTile extends StatefulWidget {
  const MainTopicExpansionTile({Key? key, required this.mainTopic, required this.database})
      : super(key: key);
...
class _MainTopicExpansionTileState extends State<MainTopicExpansionTile> {
  final TextEditingController _subTopicFieldController = TextEditingController();
